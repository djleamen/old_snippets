...
class Burrito {
    ...
    public String toString() {
        return "The cost of a " + this.size + " " + this.protein + " Burrito with " + this.rice + " rice, " + this.beans + " beans, " + this.toppings + " and " + (this.guac ? "guacamole is $" : "no guacamole is $") + getCost();
    }
